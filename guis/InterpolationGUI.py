...
class InterpolationGUI():
    ...
    def layoutGUI(self, parent, heightmap):
        ...
        radio_linear = Radiobutton(frame, text="Linear", variable=self.mode_var, value=1,
                                   command=self.updateInterpolationMode)
        radio_linear.pack()
        radio_sinusoidal = Radiobutton(frame, text="Sinusoidal", variable=self.mode_var, value=2,
                                       command=self.updateInterpolationMode)
